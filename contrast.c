...
static __Pyx_memviewslice __pyx_f_8contrast_adjust_contrast(__Pyx_memviewslice, float, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_8contrast_adjust_contrast(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img, float __pyx_v_contrast); /* proto */
...
static __Pyx_memviewslice __pyx_f_8contrast_adjust_contrast(__Pyx_memviewslice __pyx_v_img, float __pyx_v_contrast, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_b;
...
static PyObject *__pyx_pf_8contrast_adjust_contrast(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img, float __pyx_v_contrast) {
  ...
  __pyx_t_1 = __pyx_f_8contrast_adjust_contrast(__pyx_v_img, __pyx_v_contrast, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 7, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "contrast._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"adjust_contrast", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8contrast_1adjust_contrast, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
