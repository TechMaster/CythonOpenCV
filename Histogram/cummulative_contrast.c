...
{
    "distutils": {
        "name": "cummulative_contrast",
        "sources": [
            "cummulative_contrast.pyx"
        ]
    },
    "module_name": "cummulative_contrast"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cummulative_contrast
#define __PYX_HAVE_API__cummulative_contrast
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'cummulative_contrast' */
...
static __Pyx_memviewslice __pyx_f_20cummulative_contrast_auto_contrast(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "cummulative_contrast"
extern int __pyx_module_is_main_cummulative_contrast;
int __pyx_module_is_main_cummulative_contrast = 0;

/* Implementation of 'cummulative_contrast' */
...
static PyObject *__pyx_pf_20cummulative_contrast_auto_contrast(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img); /* proto */
...
static PyObject *__pyx_pw_20cummulative_contrast_1auto_contrast(PyObject *__pyx_self, PyObject *__pyx_arg_img); /*proto*/
static __Pyx_memviewslice __pyx_f_20cummulative_contrast_auto_contrast(__Pyx_memviewslice __pyx_v_img, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_width;
  int __pyx_v_height;
  ...
  float __pyx_v_scale;
  float __pyx_v_p;
  PyObject *__pyx_v_pixels_p = NULL;
  PyObject *__pyx_v_pixels_1_p = NULL;
  PyObject *__pyx_v_hist = NULL;
  PyObject *__pyx_v_cum_hist = NULL;
  PyObject *__pyx_v_cum_hist_reverse = NULL;
  ...
  __Pyx_RefNannySetupContext("auto_contrast", 0);

  /* "cummulative_contrast.pyx":11
 *     cdef int a, b
 *     cdef float scale, p
 *     p = 0.005             # <<<<<<<<<<<<<<
 *     height = img.shape[0]
 ...
 *     pixels_p = pixels * p
 */
  __pyx_v_pixels = (__pyx_v_width * __pyx_v_height);

  /* "cummulative_contrast.pyx":16
 *     pixels = width * height
 * 
 *     pixels_p = pixels * p             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = PyFloat_FromDouble((__pyx_v_pixels * __pyx_v_p)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_pixels_p = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "cummulative_contrast.pyx":17
 * 
 *     pixels_p = pixels * p
 *     pixels_1_p = pixels * (1 - p)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyFloat_FromDouble((__pyx_v_pixels * (1.0 - __pyx_v_p))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_pixels_1_p = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "cummulative_contrast.pyx":19
 *     pixels_1_p = pixels * (1 - p)
 * 
 *     hist =  cv2.calcHist([np.array(img)], [0], None, [256], [0, 256])             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_calcHist); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 19, __pyx_L1_error)
  ...
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_img, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = NULL;
  ...
  if (PyFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[6] = {__pyx_t_7, __pyx_t_5, __pyx_t_2, Py_None, __pyx_t_4, __pyx_t_6};
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_8, 5+__pyx_t_8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[6] = {__pyx_t_7, __pyx_t_5, __pyx_t_2, Py_None, __pyx_t_4, __pyx_t_6};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_8, 5+__pyx_t_8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_hist, __pyx_n_s_cumsum); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_9 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_cum_hist = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "cummulative_contrast.pyx":21
 *     hist =  cv2.calcHist([np.array(img)], [0], None, [256], [0, 256])
 *     cum_hist = hist.cumsum()
 *     a_low = np.argmax(cum_hist >= pixels_p)             # <<<<<<<<<<<<<<
 *     cum_hist_reverse = cum_hist[::-1]
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_argmax); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_RichCompare(__pyx_v_cum_hist, __pyx_v_pixels_p, Py_GE); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_t_6 = NULL;
  ...
  __pyx_v_a_low = __pyx_t_8;

  /* "cummulative_contrast.pyx":22
 *     cum_hist = hist.cumsum()
 *     a_low = np.argmax(cum_hist >= pixels_p)
 *     cum_hist_reverse = cum_hist[::-1]             # <<<<<<<<<<<<<<
 *     a_high = 255 - np.argmax(cum_hist_reverse <= pixels_1_p)
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_v_cum_hist, __pyx_slice_); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_cum_hist_reverse = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "cummulative_contrast.pyx":23
 *     a_low = np.argmax(cum_hist >= pixels_p)
 *     cum_hist_reverse = cum_hist[::-1]
 *     a_high = 255 - np.argmax(cum_hist_reverse <= pixels_1_p)             # <<<<<<<<<<<<<<
 *     scale = 255.0 / (a_high - a_low)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_argmax); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = PyObject_RichCompare(__pyx_v_cum_hist_reverse, __pyx_v_pixels_1_p, Py_LE); __Pyx_XGOTREF(__pyx_t_9); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 23, __pyx_L1_error)
  __pyx_t_6 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_SubtractCObj(__pyx_int_255, __pyx_t_1, 0xFF, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_a_high = __pyx_t_8;

  /* "cummulative_contrast.pyx":24
 *     cum_hist_reverse = cum_hist[::-1]
 *     a_high = 255 - np.argmax(cum_hist_reverse <= pixels_1_p)
 *     scale = 255.0 / (a_high - a_low)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_8 = (__pyx_v_a_high - __pyx_v_a_low);
  if (unlikely(__pyx_t_8 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 24, __pyx_L1_error)
  }
  __pyx_v_scale = (255.0 / ((double)__pyx_t_8));

  /* "cummulative_contrast.pyx":26
 *     scale = 255.0 / (a_high - a_low)
 * 
 *     for y in range(height):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_img.shape[0];
      if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_img.shape[1];
      __pyx_v_a = (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img.data + __pyx_t_15 * __pyx_v_img.strides[0]) ) + __pyx_t_16 * __pyx_v_img.strides[1]) )));

      /* "cummulative_contrast.pyx":29
 *         for x in range(width):
 *             a = img[y, x]
 *             if a < a_low:             # <<<<<<<<<<<<<<
 *                 b = 0
 *             elif a > a_high:
 */
      __pyx_t_17 = ((__pyx_v_a < __pyx_v_a_low) != 0);
      if (__pyx_t_17) {

        /* "cummulative_contrast.pyx":30
 *             a = img[y, x]
 *             if a < a_low:
 *                 b = 0             # <<<<<<<<<<<<<<
 *             elif a > a_high:
 ...
 *             else:
 */
      __pyx_t_17 = ((__pyx_v_a > __pyx_v_a_high) != 0);
      if (__pyx_t_17) {

        /* "cummulative_contrast.pyx":32
 *                 b = 0
 *             elif a > a_high:
 *                 b = 255             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      /*else*/ {
        __pyx_v_b = ((int)((__pyx_v_a - __pyx_v_a_low) * __pyx_v_scale));
      }
      __pyx_L7:;

      /* "cummulative_contrast.pyx":36
 *                 b = int((a - a_low) * scale)
 * 
 *             img[y, x] = b             # <<<<<<<<<<<<<<
 *     return img
 */
      ...
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_img.shape[0];
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_img.shape[1];
      *((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img.data + __pyx_t_18 * __pyx_v_img.strides[0]) ) + __pyx_t_19 * __pyx_v_img.strides[1]) )) = __pyx_v_b;
    }
  }

  /* "cummulative_contrast.pyx":37
 * 
 *             img[y, x] = b
 *     return img             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("cummulative_contrast.auto_contrast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __pyx_L2:;
  __Pyx_XDECREF(__pyx_v_pixels_p);
  __Pyx_XDECREF(__pyx_v_pixels_1_p);
  __Pyx_XDECREF(__pyx_v_hist);
  __Pyx_XDECREF(__pyx_v_cum_hist);
  __Pyx_XDECREF(__pyx_v_cum_hist_reverse);
...
/* Python wrapper */
static PyObject *__pyx_pw_20cummulative_contrast_1auto_contrast(PyObject *__pyx_self, PyObject *__pyx_arg_img); /*proto*/
static PyObject *__pyx_pw_20cummulative_contrast_1auto_contrast(PyObject *__pyx_self, PyObject *__pyx_arg_img) {
  __Pyx_memviewslice __pyx_v_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("auto_contrast (wrapper)", 0);
  assert(__pyx_arg_img); {
    __pyx_v_img = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_arg_img, PyBUF_WRITABLE); if (unlikely(!__pyx_v_img.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_20cummulative_contrast_auto_contrast(__pyx_self, __pyx_v_img);
...
static PyObject *__pyx_pf_20cummulative_contrast_auto_contrast(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img) {
  ...
  if (unlikely(!__pyx_v_img.memview)) { __Pyx_RaiseUnboundLocalError("img"); __PYX_ERR(0, 7, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_20cummulative_contrast_auto_contrast(__pyx_v_img, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 7, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cummulative_contrast.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "cummulative_contrast.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cummulative_contrast.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cummulative_contrast._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"auto_contrast", (PyCFunction)__pyx_pw_20cummulative_contrast_1auto_contrast, METH_O, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cummulative_contrast(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cummulative_contrast},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcummulative_contrast(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcummulative_contrast(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cummulative_contrast(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cummulative_contrast(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cummulative_contrast(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cummulative_contrast' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cummulative_contrast(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cummulative_contrast", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cummulative_contrast) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cummulative_contrast")) {
      if (unlikely(PyDict_SetItemString(modules, "cummulative_contrast", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cummulative_contrast", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cummulative_contrast");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
